...
public class WriteLoops {
    ...
    public int oneToFive() {
        ...
        // Write a FOR loop that counts from 1 to 10. <-<-<--This says ten-------<
            // calling
            for(int i = 1; i <=5; i++){
            w = w + 1;
        }
    ...
    public void simpleLoops() {
        ...
        // what's the primary difference between them?!? The do while will run once no matter the value given to i.
    }
    ...
    public int foo() {
        ...
        for (int index : threes_array) {
            sumOfThrees  += threes_array[index]; //asdf
            // calling
            w = w + 1;
            // each time through the inner loop
        }
