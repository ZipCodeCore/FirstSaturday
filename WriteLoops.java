...
public class WriteLoops {
    ...
    public int oneToFive() {
        ...
        // Write a FOR loop that counts from 1 to 10 (X) 5 (O).
        for(int i = 1; i <=5; i++){
            // calling
            w = w + 1;
    ...
    public void simpleLoops() {
        ...
        // first one check i first
        // second one do the code first THEN check
    }
    ...
    public int manageYardAndJunior() {
        ...
        sendJuniorBackToSchool("Junior is happy that he doesn't have to mow yard");
    ...
    public int tallyVote1() {
        ...
        for (String president: voteTallies){
