...
public class WriteLoops {
    ...
    public void simpleLoops() {
        ...
        // what's the primary difference between them?!?
            // the standard while loop verifies that the condition is met before executing the conrtents of the while loop
            // The do while loop executes the code within the do loop and only repeats if the while condition is met
    }
    ...
    public int foo() {
        ...
        for (int value : threes_array) {
            sumOfThrees = sumOfThrees + value;
            // calling
            w = w + 1;
            // each time through the inner loop
        }
    ...
    private boolean yardNeedsMowed() {
        return true;
    }
