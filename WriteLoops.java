...
public class WriteLoops {
    ...
    public int startAtTwentyOne() {
        int w = 0;
        for (int startAtTwentyOne = 21; startAtTwentyOne <= 31; startAtTwentyOne++){
            w = w + 1; 
        }
    ...
    public boolean checkGameScore() {
        ...
        while(runningScore <= highestScore){
                 ...
                 w = w + 1;
                 //System.out.println(currentScore + gameNextScore());
                }
    ...
    public int checkServerStatus() {
        ...
        while (serverIsRunning() ){
            if (serverIsRunning() == true){
               ...
               sendEmergencyText("Help!", "+1 202 456 1111"); 
                 tryServerRestart(null, null);
            }
                w = w + 1;
            }
