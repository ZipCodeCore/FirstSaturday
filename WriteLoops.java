 ...
 *
 * @author anonymous coward (deserves to get defenestrated) 
 * @version -0.3
 * 
 */
public class WriteLoops {
    ...
    public int startAtTwentyOne() {
        ...
        // Write a FOR loop that makes 11 iterations, start at 21.
        // calling
    ...
    public int helloZipCode() {
        ...
        // loop index counter and if it’s greater than or equal to 51,
